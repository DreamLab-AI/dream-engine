...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR-0001](./ADR-0001-dream-machine-engine.md) | The Dream Engine engine — a config-driven, evidence-gated nightly evolution loop composed from the ruvnet stack | Accepted (v0.1.0 shipped) |
